...
public class Gestora_Empleado {
    ...
    public Empleado modifyEmpleadoFactura(String dniViejo) {
        ...
        switch (opcion) {
            ...
            case 1: // modificar todos
                ...
                empleados.remove(e.getDni()); // remover viejo
                e.setDni(dni);
        ...
        // SIEMPRE aseguramos que quede en el mapa bajo su nuevo DNI
        empleados.put(e.getDni(), e);
